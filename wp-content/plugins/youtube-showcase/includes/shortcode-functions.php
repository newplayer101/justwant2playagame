...
function emd_get_std_pagenum() {
        ...
        $myentity = isset($_GET['entity']) ? $_GET['entity'] : '';
        $myview = isset($_GET['view']) ? $_GET['view'] : '';
	$shc_count = isset($_GET['view_count']) ? $_GET['view_count'] : 1;
        $myapp = isset($_GET['app']) ? $_GET['app'] : '';
        $atts_filter = isset($_GET['atts']) ? $_GET['atts'] : '';
        if (!empty($myentity)) {
